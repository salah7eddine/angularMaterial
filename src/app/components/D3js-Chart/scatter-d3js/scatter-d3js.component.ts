...
@Component({
  selector: 'app-scatter-d3js',
  templateUrl: './scatter-d3js.component.html',
  styleUrls: ['./scatter-d3js.component.css'],
})
export class ScatterD3jsComponent implements OnInit {
  private data = [
